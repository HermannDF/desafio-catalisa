...
//Funcao de busca e exibicao do primeiro personagem na API 
pegarPersonagem1 = () => {
...
//Funcao de busca e exibicao do segundo personagem na API 
pegarPersonagem2 = () => {
    let numeroAleatorio = gerarValorAleatorio();
    return fetch(`https://rickandmortyapi.com/api/character/${numeroAleatorio}`, {
        method:'GET',
...
//Funcao de busca e exibicao do terceiro personagem na API 
pegarPersonagem3 = () => {
    let numeroAleatorio = gerarValorAleatorio();
    return fetch(`https://rickandmortyapi.com/api/character/${numeroAleatorio}`, {
        method:'GET',
